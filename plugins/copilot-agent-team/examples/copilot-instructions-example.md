...
> Use this as a starting template for your `.github/copilot-instructions.md`. Replace the placeholders with your own values, or run the `team-init` skill to fill them in automatically.
